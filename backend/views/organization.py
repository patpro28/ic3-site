...
from backend.forms import EditOrganizationForm
from backend.models import Organization, OrganizationRequest, Profile
...
class OrganizationMixin(object):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["logo_override_image"] = self.object.logo
        return context
...
class OrganizationDetailView(OrganizationMixin, DetailView):
    def get(self, request, *args, **kwargs):
        ...
        if self.object.slug != kwargs["organization"]:
            return HttpResponsePermanentRedirect(
                reverse("organization_home", args=(self.object.id, self.object.slug))
            )
...
class OrganizationUsers(OrganizationDetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["kick_url"] = reverse(
            "organization_kick_user", kwargs={'organization': self.object.slug}
        )
        return context

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.FloatField(db_index=True, null=True, verbose_name='completion time')),
                ('points', models.FloatField(db_index=True, null=True, verbose_name='points granted')),
                ('result', models.CharField(blank=True, choices=[('AC', 'Accepted'), ('WA', 'Wrong Answer')], db_index=True, default=None, max_length=3, null=True, verbose_name='result')),
            ...
            options={
                ...
                'permissions': (('view_all_submission', 'View all submission'),),
            },
        ),
        migrations.CreateModel(
            name='Problem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.submission', verbose_name='submission')),
            ],
            options={
